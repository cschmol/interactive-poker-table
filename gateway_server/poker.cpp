...
FILE	*asdf;										/* output-file pointer */
char	*asdf_file_name = "";		/* output-file name    */

asdf	= fopen( asdf_file_name, "w" );
if ( asdf == NULL ) {
	fprintf ( stderr, "couldn't open file '%s'; %s\n",
			asdf_file_name, strerror(errno) );
	exit (EXIT_FAILURE);
}

if( fclose(asdf) == EOF ) {			/* close output file   */
...
FILE	*asdfasdf;										/* input-file pointer */
char	*asdfasdf_file_name = "asdfasdfasdf
";		/* input-file name    */
#===============================================================================
#
#     Filename: Makefile
...
asdfasdf	= fopen( asdfasdf_file_name, "r" );
if ( asdfasdf == NULL ) {
	fprintf ( stderr, "couldn't open file '%s'; %s\n",
			asdfasdf_file_name, strerror(errno) );
	exit (EXIT_FAILURE);
}

if( fclose(asdfasdf) == EOF ) {			/* close input file   */
	fprintf ( stderr, "couldn't close file '%s'; %s\n",
			asdfasdf_file_name, strerror(errno) );
	exit (EXIT_FAILURE);
}
