 ...
 * =====================================================================================
 *
 *       Filename:  card_deck.cpp
 *
 *    Description:  Card deck for the poker game
 *
 *        Version:  1.0
 *        Created:  2015-04-30 00:03:53
 *       Revision:  none
 *       Compiler:  gcc
 *
...
class Card_deck
{
	public:
		...
		void shuffle() {
			std::random_shuffle(poker_deck.begin(), poker_deck.end()); /* shuffle the deck */
			return;
		}
		void reset();
